...
SECRET_KEY = 'django-insecure-86&pgt!xoh=!!g*jclzy(yozh*dufn@v_ri(qci=5dm+x$zv#k'
...
LOGIN_REDIRECT_URL = 'inicio' # Nombre de la ruta
LOGOUT_REDIRECT_URL = 'login' # Nombre de la ruta
